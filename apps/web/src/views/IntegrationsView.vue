...
@media (max-width: 760px) { .drawer { padding: 18px 14px; }.integration-form-grid { grid-template-columns: 1fr; }.integration-form-grid .field-wide, .integration-form-actions { grid-column: auto; }.integration-form-actions { justify-content: stretch; }.integration-form-actions button { flex: 1; } }
</style>
